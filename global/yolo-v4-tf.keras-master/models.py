...
class Yolov4(object):
    def __init__(self,
        ...
        if type(class_name_path) == list:
            self.class_names = class_name_path
        else:
        ...
        self.score_threshold = yolo_config['score_threshold']
        ...
        if yolo_config['num_gpu'] > 1:
            ...
            with mirrored_strategy.scope():
                ...
                print("Succesfully builded parallel model.")
        else:
            self.build_model(load_pretrained=True if self.weight_path else False)
            #print("Succesfully builded model.")
    ...
    def export_gt(self, annotation_path, gt_folder_path):
        with open(annotation_path, encoding='ISO-8859-1') as file:
            for line in file:
                line = line.split(' ')
                filename = line[0].split(os.sep)[-1].split('.')[0]
                objs = line[1:]
                # export txt file
                with open(os.path.join(gt_folder_path, filename + '.txt'), 'w', encoding='ISO-8859-1') as output_file:
                    for obj in objs:
        ...
        with open(annotation_path, encoding='ISO-8859-1') as file:
            ...
            for batch_idx in tqdm(range(0, len(img_paths), bs)):
                ...
                for k in range(len(paths)):
                    ...
                    with open(output_path, 'w', encoding='ISO-8859-1') as pred_file:
    ...
    def eval_map(self, gt_folder_path, pred_folder_path, temp_json_folder_path, output_files_path):
        ...
        for txt_file in ground_truth_files_list:
            ...
            with open(new_temp_file, 'w', encoding='ISO-8859-1') as outfile:
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            with open(temp_json_folder_path + "/" + class_name + "_dr.json", 'w', encoding='ISO-8859-1') as outfile:
                json.dump(bounding_boxes, outfile)
        ...
        with open(output_files_path + "/output.txt", 'w', encoding='ISO-8859-1') as output_file:
            ...
            for class_index, class_name in enumerate(gt_classes):
                ...
                dr_data = json.load(open(dr_file, encoding='ISO-8859-1'))
                ...
                for idx, detection in enumerate(dr_data):
                    ...
                    ground_truth_data = json.load(open(gt_file, encoding='ISO-8859-1'))
                    ovmax = -1
                    gt_match = -1
                    ...
                    if ovmax >= min_overlap:
                        ...
                        if not bool(gt_match["used"]):
                            ...
                            with open(gt_file, 'w', encoding='ISO-8859-1') as f:
    ...
    def predict_nonms(self, img_path, iou_threshold= 0.4, score_threshold=0.1):
